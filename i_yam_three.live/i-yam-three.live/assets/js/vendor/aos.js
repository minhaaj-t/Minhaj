!(function (e, t) {
  ...
  function B(n, o, e) {
    ...
    function g() {
      ...
      if (((i = arguments), (a = this), (u = e), t)) {
        if (void 0 === c)
          return (d = e = u), (c = setTimeout(b, o)), l ? f(e) : s;
  ...
  function j(e) {
    ...
    if (
      "symbol" == typeof (t = e) ||
      (t && "object" == typeof t && V.call(t) == I)
    )
      return c;
    if (
      "string" !=
      typeof (e = O(e)
        ? O((t = "function" == typeof e.valueOf ? e.valueOf() : e))
          ? t + ""
          : t
        : e)
    )
          ...
          u.initClassName && e.node.classList.add(u.initClassName),
            (e.position = {
              ...
              out:
                ...
                i &&
                  document.querySelectorAll(i) &&
                  (o = document.querySelectorAll(i)[0]),
      ...
      return (
        ...
        A(S.disable) || E()
          ...
          : (document
            ...
            -1 === ["DOMContentLoaded", "load"].indexOf(S.startEvent)
