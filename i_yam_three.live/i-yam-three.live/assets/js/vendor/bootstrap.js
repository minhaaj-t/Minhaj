!(function (e, t) {
  ...
  const f = {
    ...
    $ = (i, n, e = !0) => {
      if (e) {
        ...
        const s = ({ target: e }) => {
          e === n &&
            ((t = !0), n.removeEventListener("transitionend", s), l(i));
        };
  ...
  function Se(e) {
    ...
    return (
      ((!s ||
        ("html" !== v(s) && ("body" !== v(s) || "static" !== A(s).position))) &&
        (s ||
          (function (e) {
        ...
        (n =
          "clippingParents" === (c = l)
            ? ((o = Ge(xe((n = i)))),
              Te(
                (s =
                  0 <= ["absolute", "fixed"].indexOf(A(n).position) && w(n)
                    ? Se(n)
                    : n)
              )
                ? o.filter(function (e) {
  ...
  var it = {
    ...
    fn: function (e) {
      ...
      if (!d.modifiersData[e]._skip) {
        ...
        d.placement !== b &&
          ((d.modifiersData[e]._skip = !0), (d.placement = b), (d.reset = !0));
      }
    },
                      ...
                      (("body" === v(r) && !Qe(l)) ||
                        (h =
                          (c = r) !== y(c) && w(c)
                            ...
                            : Xe(c)),
                      w(r)
                        ? (((d = E(r)).x += r.clientLeft), (d.y += r.clientTop))
                        : l && (d.x = Ye(l))),
                    {
          ...
          if ((e.preventDefault(), e.stopPropagation(), !a(this)))
            return (
              ...
              "Escape" === e.key
                ...
                ? (i || t().click(), void C.getInstance(t())._selectMenuItem(e))
                : void ((i && "Space" !== e.key) || C.clearMenus())
            );
      }
    }
  }
  ...
  class Lt {
    ...
    _getConfig(e) {
      return (
        ((e = { ...Ct, ...("object" == typeof e ? e : {}) }).rootElement = o(
          e.rootElement
        )),
        i("backdrop", e, kt),
        e
  ...
  class j extends t {
    ...
    show(e) {
      this._isShown ||
        ...
        this._backdrop.show(),
        this._config.scroll ||
          (new Ot().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.classList.add("show"),
  ...
  b.on(
    ...
    b.on(window, "load.bs.offcanvas.data-api", () =>
      f.find(".offcanvas.show").forEach((e) => j.getOrCreateInstance(e).show())
    ),
    e(j);
  const jt = new Set([
      "background",
        ...
        a.forEach((e) => {
          ((e, t) => {
            ...
            if (t.includes(i))
              return (
                !jt.has(i) ||
                Boolean(Mt.test(e.nodeValue) || Pt.test(e.nodeValue))
              );
        ...
        return r(t)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (t = Ht(t, this._config.allowList, this._config.sanitizeFn)),
                (e.innerHTML = t))
              : (e.textContent = t));
    }
    getTitle() {
