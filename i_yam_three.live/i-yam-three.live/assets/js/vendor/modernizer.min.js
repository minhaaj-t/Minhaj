!(function (s, f, c) {
  ...
  function a(e, t) {
    if ("object" == typeof e) for (var n in e) u(e, n) && a(n, e[n]);
    else {
      ...
      (t = "function" == typeof t ? t() : t),
        1 == o.length
          ? (_[o[0]] = t)
          : (!_[o[0]] ||
              _[o[0]] instanceof Boolean ||
              (_[o[0]] = new Boolean(_[o[0]])),
            (_[o[0]][o[1]] = t)),
        i([(t && 0 != t ? "" : "no-") + o.join("-")]),
        _._trigger(e, t);
    }
  ...
  function h(e, t, n, o) {
    ...
    for (
      ...
      (i = !0), (B.modElem = p(d.shift())), (B.style = B.modElem.style);
  ...
  var u,
    ...
    k =
      ((x._domPrefixes = P),
      x._config.usePrefixes
        ? " -webkit- -moz- -o- -ms- ".split(" ")
        : ["", ""]),
    q =
      ((x._prefixes = k),
      (u =
        void 0 === (d = {}.hasOwnProperty) || void 0 === d.call
          ? function (e, t) {
      ...
      function (e, t) {
        ...
        return (
          ...
          (!(n =
            (e = "on" + e) in
            (t = t && "string" != typeof t ? t : p(t || "div"))) &&
            A &&
            ((t = t.setAttribute ? t : p("div")).setAttribute(e, ""),
    ...
    k =
      ...
      _.addTest("pointerevents", function () {
        for (
          var e = !1, t = P.length, e = _.hasEvent("pointerdown");
          t-- && !e;
  ...
  for (
    ...
    (z = L[N].toLowerCase()),
      (O = n("column" + L[N])),
      ("breakbefore" !== z && "breakafter" !== z && "breakinside" != z) ||
        (O = O || n(L[N])),
  ...
  S))
    if (S.hasOwnProperty(w)) {
      ...
      for (y = m(g.fn, "function") ? g.fn() : g.fn, C = 0; C < e.length; C++)
        1 === (b = e[C].split(".")).length
          ? (_[b[0]] = y)
          : (!_[b[0]] ||
              _[b[0]] instanceof Boolean ||
              (_[b[0]] = new Boolean(_[b[0]])),
            (_[b[0]][b[1]] = y)),
          M.push((y ? "" : "no-") + b.join("-"));
    }
